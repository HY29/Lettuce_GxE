...
HY5.Exp.long.Meta.Mean$Light <- factor(HY5.Exp.long.Meta.Mean$Light, levels=c("WhiteLED", "RedLED","BlueLED","FL"))
HY5.Exp.long.Meta$Light <- factor(HY5.Exp.long.Meta$Light, levels=c("WhiteLED", "RedLED","BlueLED","FL"))
...
ggsave("Fig/FigS10a_LinePlot_GeneExp_HY5_Light.pdf", width=3.2, height=2)
...
ggsave("Fig/FigS10b_BoxPlot_GeneExp_HY5_Light.pdf", width=3.2, height=2)
